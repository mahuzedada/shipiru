...
echo -e "${GREEN}Starting basic DevOps stack installation...${NC}"
...
ansible-playbook -i ansible/inventories/hosts ansible/site.yml -e "setup_type=basic"
...
echo -e "${GREEN}Basic installation completed successfully!${NC}"
